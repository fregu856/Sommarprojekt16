...
#define CORRIDOR_SIDE_DISTANCE 25 // Distance for determining whether in corridor or not
...
void update_state()
{
    ...
    switch (AUTO_STATE)
	{
        ...
        case JUNCTION_C:
        {
            if ((IR_0 > 40) && (IR_1 < CORRIDOR_SIDE_DISTANCE) && (IR_2 < CORRIDOR_SIDE_DISTANCE))
            {
                AUTO_STATE = OUT_OF_JUNCTION;
                cycle_count = 0;
            }
